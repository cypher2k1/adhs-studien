...
function saveSCORM(){
	doLMSSetValue( "cmi.core.score.raw" , simpleScore());
	doLMSSetValue( "cmi.core.lesson_location" , actualPage);
	doLMSSetValue( "cmi.core.lesson_status" , setStatus());
	//doLMSSetValue( "cmi.comments" , actualScoreArray.join("_"));
	doLMSSetValue( "cmi.suspend_data" , actualScoreArray.join("_"));
}
