...
<body>';
//-------------
echo '<h2>Literatur</h2>';
echo '<p>Ansicht: <a href="'.$_SERVER["SCRIPT_NAME"].'?style=text">Text</a> | <a href="'.$_SERVER["SCRIPT_NAME"]
	.'?style=table">Tabelle</a></p>';
...
switch($_GET['style']) {
	// Ansicht TABELLE -------------------------
	case 'table':
		echo '<table id="references_table">';
		literatur($data, $style="table");
		echo '<tbody></table>';
		break;
	// Ansicht TEXT ----------------------------
	case 'text':
		echo '<ol id="references_list">';
